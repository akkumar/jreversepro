...
public class Variable extends Expression {
	 ...
	 * 
	 * @param _varTable
	 *            The symbol table within which the variable is going to be
	 *            live.
	 * 
	 * @param _jvmType
	 ...
	 * 
	 */
	public Variable(VariableTable _varTable, String _jvmType,
			int _variableIndex, int _instructionIndex) {
