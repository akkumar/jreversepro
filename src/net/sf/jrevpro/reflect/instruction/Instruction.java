...
public class Instruction {
	 ...
	 */
	public Instruction(int rhsIndex, int rhsOpcode, byte[] rhsArgs,
			int rhsNext, boolean rhsWide) {
	 ...
	 * Works whether wide target or not.
	 * 
	 ...
	 * important to note is the fact this is a 'wide' variant of the
	 * conventional jump instructions.
	 * 
	 * @return Returns the offset.
	 */
