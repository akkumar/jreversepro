...
import net.sf.jrevpro.reflect.variabletable.SymbolTable;
import net.sf.jrevpro.reflect.variabletable.SymbolTableContext;
...
public class Method extends Member {
	...
	/**
	 * @param info
	 *            The JSymbolTable associated with this class Creates a new
	 *            JMethod
	 */
	public Method() {
	...
	public void addExceptionBlock(int startPc, int endPc, int handlerPc,
		...
		if (tryIndex == -1) {
			...
			MethodException oldTry = (MethodException) exceptionBlocks
					.get(tryIndex);
	 ...
	 * 
	 * @param rhsLineTable
	 *            Line number Table that is created by the compiler if the
	 *            debugging option is on.
	 */
	...
	/**
	 * Returns the .list of classes thrown by this method. The individual
	 * members are string.
	 * 
	...
	/**
	 * Sets the .list of classes thrown by this method. The individual members
	 * are string.
	 * 
	 * @param throwsClasses
	 *            Classes Thrown
	 ...
	 * maximum local information maximum stack information and the exception
	 * class handler information.
	 * 
	 ...
	 * 
	 * public void doSomething( int ,int ) //random method signature the
	 * signature will be (II)V .
	 */
	private String signature;

	/**
	 * Throws classes is a List containing String of the java data types that
	 ...
	 * information and also to provide meaningful names to parameters of a
	 * method as well as local variables in a method. This will be populated and
	 * used only when debugging is turned on [using -g option]. Else the
	 * deompiler will assign its own name.
	 * 
	 */
