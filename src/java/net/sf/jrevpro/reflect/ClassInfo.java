...
/**
 * <b>JClassInfo</b> is the abstract representation of the Class File. The
 * names of the methods are self explanatory.
 * 
...
public class ClassInfo {
	...
	/**
	 * An integer referring to the access permission of the class. Like if a
	 * class is public static void main () then the accessflag would have
	 * appropriate bits set to say if it public static.
	 */
