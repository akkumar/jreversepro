...
import org.jreversepro.ast.intermediate.SwitchLine;
 ...
 * 
 */
public class SwitchEvaluator extends AbstractInstructionEvaluator {

  /**
   * @param context
   */
  public SwitchEvaluator(EvaluatorContext context) {
    super(context);
  }
